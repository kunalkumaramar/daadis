...
export const HomePage = () => {
  ...
  <div className="w-full max-w-[320px] md:w-[277px] mx-auto relative aspect-[9/16] rounded-md bg-white border border-gray-600/50">
    <video
      src="https://res.cloudinary.com/dmrgscauc/video/upload/v1756471856/He_saves_he_blesses_he_protects_This_Chaturthi_let_s_offer_Bappa_what_he_loves_most_swe_dkdwbu.mp4"
      controls
      autoPlay
      loop
      muted
  ...
  <div className="w-full max-w-[320px] md:w-[277px] mx-auto relative aspect-[9/16] rounded-md bg-white border border-gray-600/50">
    <video
      src="https://res.cloudinary.com/dwqyjytaw/video/upload/v1756800637/get_jxznha.mp4"
      controls
      autoPlay
      loop
      muted
  ...
  <div className="w-full max-w-[320px] md:w-[277px] mx-auto relative aspect-[9/16] rounded-md bg-white border border-gray-600/50">
    <video
      src="https://res.cloudinary.com/dwqyjytaw/video/upload/v1756800755/Grab_your_work_besties_and_a_box_of_our_Besan_Ghee_Ladoo_for_a_much_needed_break_Ps._It_s_okay_ehvayl.mp4"
      controls
      autoPlay
      loop
      muted
