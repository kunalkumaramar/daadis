...
const SAMPLE_BANNERS: ISampleBanners[] = [
  {
    _id: "1",
    imageUrl: { url: "/assets/namakpara.webp", publicId: "banner1" },
    bannerName: "Namak Para",
    bannerText: "Namak Para",
    bannerType: "hero",
    bannerColours: ["A2D2DF", "FF8383"],
    bannerElementUrl: { url: "/assets/namakpara1.webp", publicId: "element1" },
  },
  {
    _id: "2",
    imageUrl: { url: "/assets/shakarpara.webp", publicId: "banner2" },
    bannerName: "Shakkar Para",
    bannerText: "Shakkar Para",
    bannerType: "hero",
    bannerColours: ["7BD3EA", "9694FF"],
    bannerElementUrl: { url: "/assets/shakarpara1.webp", publicId: "element2" },
  },
  {
    _id: "3",
    imageUrl: { url: "/assets/kaju.webp", publicId: "banner3" },
    bannerName: "Kaju Katli",
    bannerText: "Kaju Katli",
    bannerType: "hero",
    bannerColours: ["FFFFFF", "1B3C73"],
    bannerElementUrl: { url: "/assets/kaju1.png", publicId: "element3" },
  },
  {
    _id: "4",
    imageUrl: { url: "/assets/khakhra.webp", publicId: "banner4" },
    bannerName: "Peri Peri Khakhra",
    bannerText: "Peri Peri Khakhra",
    bannerType: "hero",
    bannerColours: ["F3B95F", "3B1E54"],
    bannerElementUrl: { url: "/assets/khakhra1.webp", publicId: "element4" },
  },
];
